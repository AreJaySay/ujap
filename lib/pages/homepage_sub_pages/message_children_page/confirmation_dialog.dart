                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Text( type.toString() == 'private' ? 'Supprimer définitivement cette conversation.' : type.toString() == 'groupmember' ? 'Quittez définitivement le groupe actuel.' : 'Supprimer définitivement le groupe actuel.',
                          ...
                          style: TextStyle(fontFamily: 'Google-Medium',color: Colors.black87),
                        ),
                      ),
                    ),
                    SizedBox(
                              ...
                              Expanded(
                                child: GestureDetector(
                                  child: Container(
                                    ...
                                    child: Text('Annuler',style: TextStyle(fontFamily: 'Google-Medium',color: Colors.black54)),
                                ...
                                child: Builder(
                                  builder: (context)=> GestureDetector(
                                      child: Container(
                                        ...
                                        margin: EdgeInsets.symmetric(horizontal: screenwidth/30,vertical: 5),
                                        alignment: Alignment.center,
                                        child: Text('Confirmer',style: TextStyle(fontFamily: 'Google-Medium',color: Colors.white)),
                                        decoration: BoxDecoration(
                                            color:  kPrimaryColor,
