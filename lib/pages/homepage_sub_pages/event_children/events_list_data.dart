                            ...
                            children: [
                              Container(
                                  ...
                                  Container(
                                    ...
                                    GestureDetector(
                                      child: Container(
                                        height: screenwidth < 700 ? 200 : screenheight/4.7,
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      Text("Nom du match:".toUpperCase() ,style: TextStyle(fontSize: 12,fontFamily: 'Google-Bold',color: Colors.grey[600]),),
                                                      SizedBox(
                                                        width: 5,
                                                      ),
                                                      Text(snapshot.data[index]['name'].toString().toUpperCase(),style: TextStyle(fontSize: 12,fontFamily: 'Google-Bold',color: Colors.grey[800]),overflow: TextOverflow.ellipsis,),
                                                    ],
                                                  ),
                                                  SizedBox(
                                                    height: 3,
                                                  ...
                                                  Row(
                                                    children: [
                                                      Text("Date du match:".toUpperCase(),style: TextStyle(fontSize: 12,fontFamily: 'Google-Bold',color: Colors.grey[600]),),
                                                      SizedBox(
                                                        width: 5,
                                                      ),
                                                      Text(DateFormat("d").format(DateTime.parse(snapshot.data[index]['sched_date'])).toString().toUpperCase()+' '+monthDate[int.parse(DateFormat("MM").format(DateTime.parse(snapshot.data[index]['sched_date'])).toString())].toString()+'.'+' '+DateFormat("yyyy").format(DateTime.parse(snapshot.data[index]['sched_date'])).toString().toUpperCase(),style: TextStyle(fontSize: 12,fontFamily: 'Google-Bold',color: Colors.grey[800]),),
                                                      SizedBox(
                                                        width: 10,
                                                      ),
                                                      Text(snapshot.data[index]['sched_time'].toString().substring(0,5),style: TextStyle(fontSize: 12,fontFamily: 'Google-Bold',color: Colors.grey[800]),),
                                                      SizedBox(
                                                        width: 5,
                                                      ),
                                                    ],
                                                  ...
                                                  Expanded(
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(_hometeamName[0]['name'].toString().toUpperCase(),textAlign: TextAlign.center,style: TextStyle(fontSize: 11,fontFamily: 'Google-Bold',color: Colors.grey[800]),)
                                                      ],
                                                    ),
                                                  ) :
                                                  Expanded(
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(_teamName[0]['name'].toString().toUpperCase(),textAlign: TextAlign.center,style: TextStyle(fontSize: 11,fontFamily: 'Google-Bold',color: Colors.grey[800]),)
                                                      ],
                                                    ),
                                                  ),
                                                  Text('VS',style: TextStyle(fontSize: 20,color: Color.fromRGBO(20, 74, 119, 0.9),fontFamily: 'Google-Bold'),),
                                                  snapshot.data[index]["match"]["home_court"] == 1 ?
                                                  Expanded(
                                                    child: Column(
                                                      mainAxisAlignment: MainAxisAlignment.center,
                                      ...
                                      child: Container(
                                        height: screenwidth < 700 ? 170 : screenheight/4.7,
                                        width: screenwidth,
                                        margin: EdgeInsets.only(bottom: screenwidth < 700 ? 10 : 25,left: screenwidth < 700 ? screenwidth/15 :  screenwidth/18,right:  screenwidth < 700 ? screenwidth/15 :  screenwidth/18),
                                        decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(10)
                                        ),
                                        child: Stack(
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Row(
                                                          children: [
                                                            Text( snapshot.data[index]['type'].toString().toLowerCase() == 'event' ? "NOM DE L'évènement:".toUpperCase() : "NOM DE L RÉUNION:".toUpperCase() ,style: TextStyle(fontSize: 12,fontFamily: 'Google-Bold',color: Colors.grey[600]),),
                                                            SizedBox(
                                                              width: 5,
                                                            ),
                                                            Text(snapshot.data[index]['name'].toString().toUpperCase(),style: TextStyle(fontSize: 12,fontFamily: 'Google-Bold',color: Colors.black),overflow: TextOverflow.ellipsis,),
                                                          ],
                                                        ),
                                                        SizedBox(
                                                          height: 3,
                                                        ...
                                                        Row(
                                                          children: [
                                                            Text( snapshot.data[index]['type'].toString().toLowerCase() == 'event' ? "date de l'évènement:".toUpperCase() : "Date de la réunion:".toUpperCase(),style: TextStyle(fontSize: 12,fontFamily: 'Google-Bold',color: Colors.grey[600]),),
                                                            SizedBox(
                                                              width: 5,
                                                            ),
                                                            Text(DateFormat("d").format(DateTime.parse(snapshot.data[index]['sched_date'])).toString().toUpperCase()+' '+monthDate[int.parse(DateFormat("MM").format(DateTime.parse(snapshot.data[index]['sched_date'])).toString())].toString()+'.'+' '+DateFormat("yyyy").format(DateTime.parse(snapshot.data[index]['sched_date'])).toString().toUpperCase(),style: TextStyle(fontSize: 12,fontFamily: 'Google-Bold',color: Colors.black),),
                                                            SizedBox(
                                                              width: 10,
                                                            ),
                                                            Text(snapshot.data[index]['sched_time'].toString().substring(0,5),style: TextStyle(fontSize: 12,fontFamily: 'Google-Bold',color: Colors.black),),
                                                            SizedBox(
                                                              width: 5,
                                                            ),
                                                          ],
