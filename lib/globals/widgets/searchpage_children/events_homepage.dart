...
class EventsHomepage extends StatefulWidget {
  ...
  final int index;
  EventsHomepage(this.eventList,this.index);
  @override
                ...
                children: <Widget>[
                  Container(
                    child: Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Text(widget.eventList[widget.index]['type'].toString().toLowerCase() == 'event' ? "Nom de l' évènement: " : widget.eventList[widget.index]['type'].toString().toLowerCase() == 'meeting' ? 'Nom de la réunion: ' : 'Nom du match: ',style: TextStyle(color: Colors.grey[800],fontSize: screenwidth < 700 ? screenheight/65 : 20,fontFamily: 'Google-Medium'),),
                        Container(
                  ...
                  Row(
                    children: [
                      Text( widget.eventList[widget.index]['type'].toString().toLowerCase() == 'event' ? "Date de l'évènement:" : widget.eventList[widget.index]['type'].toString().toLowerCase() == 'meeting' ? "Date de la réunion:" : "Date du match:",style: TextStyle(color: Colors.grey[800],fontSize: screenwidth < 700 ? screenheight/65 : 20,fontFamily: 'Google-Medium'),),
                      SizedBox(
                        width: 5,
                      ),
